...
public class ShortcutEditWindow implements View.OnKeyListener, View.OnClickListener {

    private Context mContext;
    private PopupWindow editWindow;
    private ShortcutView baseView;
    private static ShortcutEditWindow INSTANCE;
    private ShortcutEditWindow(Context context) {
        this.mContext = context;
    }

    public static ShortcutEditWindow getInstance(Context context) {
        if(INSTANCE == null) {
            INSTANCE = new ShortcutEditWindow(context);
        }
        return INSTANCE;
    }
